          ...
          <tbody class="d-flex flex-column ts-text">
            ...
            ?>
                  <tr>
                    ...
                    <td class="text-muted ts-store-name">שם הת”ת: <span class="ts-text-normal"><?php echo $transaction["community_data"]->community_name; ?></span> </td>
                    <td class="ts-guy-name ">שם הלקוח:<span class="ts-text-normal"><?php echo $transaction["member_data"]->full_name; ?></span></td>
                  </tr><?php
                      } else {
