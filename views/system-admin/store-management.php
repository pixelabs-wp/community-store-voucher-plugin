            ...
            ?>
                <div class="store-management-card card col-xl-4 rounded-3 p-0" data-bs-toggle="modal" data-bs-target="#store-details">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="w-35" style="border-top-right-radius: 8px; position: relative; border-bottom-right-radius: 8px; height: 150px; background-image: url(<?php echo $store["store_logo"] ? $store["store_logo"] : 'https://placehold.co/600x400'; ?>); background-position: center; background-size: cover; background-repeat: no-repeat;">
                                ...
                                <div class="row-1 p-2 d-flex align-items-center justify-content-end">
                                    <table>
                                        ...
                                        <tr class="d-flex flex-column gap-2 text-right" style="direction: rtl;">
                                            ...
                                            <td><strong>שם החנות: </strong><?php echo $store["store_name"] ?></td>
                                            <td><strong>כתובת החנות: </strong><?php echo $store["store_address"] ?></td>
                                            <td><strong>מספר טלפון: </strong> <?php echo $store["store_phone"] ?></td>
                                            <td><strong>ישיבות בהסדר:</strong> <?php echo $store["store_name"] ?></td>
