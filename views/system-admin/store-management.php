                        ...
                        <div class="container mt-5 d-flex flex-column gap-5">
                            <div class="row">
                                ...
                                <div class="mb-3 col-xl-6">
                                    ...
                                    <input type="text" class="form-control" id="store_address_id" name="store_address">
                                </div>


                                <div class="mb-3 col-xl-6">
                                    <label class="form-label">שם החנות</label>
                                    <input type="text" class="form-control" id="store_name_id" name="store_name" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-xl-6">
                                    ...
                                    <input type="text" class="form-control" id="store_cashier_phone_id" name="store_cashier_phone">
                                </div>

                                <div class="mb-3 col-xl-6">
                                    <label class="form-label">טלפון</label>
                                    <input type="text" class="form-control" id="store_phone_id" name="store_phone">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-xl-6">
                                    ...
                                    <input type="email" class="form-control" readonly id="store_mail_address_id" name="store_mail_address">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-xl-12">
                                    ...
                                    <input type="text" class="form-control" id="fee_amount_per_transaction_id" name="fee_amount_per_transaction">
                                </div>

                            </div>
                            <input type="hidden" id="store_id_" name="store_id" value="">
                            <input type="hidden" id="user_id_" name="user_id" value="">
                            <input type="hidden" id="oldpath_id" name="oldpath" value="">
                            <input type="hidden" name="csvp_request" value="update_store">
                            <input type="submit" class="btn btn-dark " value="← לעדכון החנות במערכת">
                    ...
                    <div class="store-management-card card col-xl-4 rounded-3 p-0 <?php echo $noDebt; ?>" data-bs-toggle="modal" data-bs-target="#store-details">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            ...
                            <div class="w-35" style="border-top-right-radius: 8px; position: relative; border-bottom-right-radius: 8px; height: 150px; background-image: url(<?php echo $imageUrl ? $imageUrl : 'https://placehold.co/600x400'; ?>); background-position: center; background-size: cover; background-repeat: no-repeat;">
                                <svg data-bs-toggle="modal" data-bs-target="#edit-store-details" data-id="<?php echo $store['id']; ?>" style="position: absolute; top: 8px; right: 8px;" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
jQuery('#edit-store-details').on('show.bs.modal', function(event) {
        ...
        jQuery.ajax({
			...
			data: {
				...
				csvp_handler: 'get_store_data_by_id', // Action hook
				data: {
					id: store_id
				}
			},
			...
			success: function(response) {
                document.getElementById("store_address_id").value = response.store_address;
                document.getElementById("store_name_id").value = response.store_name;
                document.getElementById("store_cashier_phone_id").value = response.store_cashier_phone;
                document.getElementById("store_phone_id").value = response.store_phone;
                document.getElementById("store_mail_address_id").value = response.store_mail_address;
                document.getElementById("fee_amount_per_transaction_id").value = response.fee_amount_per_transaction;
                document.getElementById("store_id_").value = response.id;
                document.getElementById("oldpath_id").value = response.store_logo;
                store_user_id = response.wp_user_id;
                userdata(store_user_id);
    ...
    function userdata(store_user_id)
    {
        jQuery.ajax({
			url: "<?php echo admin_url('admin-ajax.php'); ?>",
			type: 'POST',
			data: {
				action: 'csvp_ajax', // Action hook
				csvp_request: 'CSVP_Store', // Action hook
				csvp_handler: 'get_store_user_data_by_id', // Action hook
				data: {
					id: store_user_id
				}
			},
