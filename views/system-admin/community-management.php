...
<div class="modal fade" id="community-full-details-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body-rounded p-1 m-1 filter-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col row justify-content-right">
                                <button class="font-weight-medium ts-text btn border-0 text-right w-20" onclick='outToExcel( <?php echo isset($pageData["communities"]) ? json_encode($pageData["communities"]) : "[]"; ?>)'>יצא לאקסל</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ?>
                    ...
                    <div class="store-management-card card col-xl-4 rounded-3 p-0 <?php echo $noDebt; ?>" data-bs-toggle="modal" data-bs-target="#store-details">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            ...
                            <div class="w-35" style="border-top-right-radius: 8px; position: relative; border-bottom-right-radius: 8px; height: 150px; background-image: url(<?php echo home_url() . '/wp-content/uploads'.$imageUrl ? $imageUrl : 'https://placehold.co/600x400'; ?>); background-position: center; background-size: cover; background-repeat: no-repeat;">
                                    ...
                                    <div class="row-1 p-2 d-flex align-items-center justify-content-end">
                                        <table>
                                            ...
                                            <tr class="d-flex flex-column gap-2 text-right" style="direction: rtl;">
                                                ...
                                                <td><strong>שם הישיבה:</strong> <?php echo $community["community_name"]; ?></td>
                                                <td><strong>שם ראש הת”ת: </strong> <?php echo $community["community_manager_name"]; ?></td>
                                                <td><strong>מספר טלפון:</strong> <?php echo $community["community_manager_phone"]; ?></td>
                                                <td><strong>כמות בחורים:</strong> <?php echo $community["number_of_guys"]; ?></td>
                            ...
                            <li class="page-item page-next">
                                <a class="page-link" href="#">
                                    <div class="page-item-title text-white mx-4" style="font-size: 20px">
                                        סה”כ ישיבות: <?php echo $pageData["total_communities"]; ?> </div>
                                </a>
                            </li>
                        </ul>
                    </div>
