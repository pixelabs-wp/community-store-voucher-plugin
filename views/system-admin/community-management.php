        ...
        <div class="container mt-4 d-flex flex-wrap" style="row-gap: 1rem; column-gap: 1rem;">
            ...
            <div class="store-management-card card col-xl-4 rounded-3 p-0" data-bs-toggle="modal"
                ...
                <div class="card-body d-flex flex-column p-0">
                    ...
                    <div class="w-35"
                        style="border-top-right-radius: 8px; position: relative; border-bottom-right-radius: 8px; height: 150px; background-image: url(media/inviting-logo.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
                            ...
                            <div class="row-1 p-2 d-flex align-items-center justify-content-end">
                                <table>
                                    ...
                                    <tr class="d-flex flex-column gap-2 text-right" style="direction: rtl;">
                                        ...
                                        <td><strong>שם הישיבה:</strong>בית מתיתיהו</td>
                                        <td><strong>שם ראש הת”ת: </strong>אלעזר מיארה</td>
                                        <td><strong>מספר טלפון:</strong> 054-6268012</td>
                                        <td><strong>כמות בחורים:</strong> 450</td>
            ...
            <div class="store-management-card card col-xl-4 rounded-3 p-0 no-debt" data-bs-toggle="modal"
                data-bs-target="#store-details">
                <!-- Photo -->
                <div class="card-body d-flex flex-column p-0">
