    ...
    <div class="modal-dialog modal modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content p-4">
            <form action="" method="post">
                <input type="hidden" name="csvp_request" value="pay_commision">
                    ...
                    <div class="filter-popup" id="filter-guys-popup" style="z-index: -1;">
                        <form action="" method="post">
                            ...
                            <div class="" style="direction: rtl;">
                                ...
                                <input type="month" id="start" class="form-control" name="month_year" min="2018-03" value="<?php echo isset($_POST["month_year"]) ? $_POST["month_year"] : ""; ?>" />
                    ...
                    <div class="card-body-rounded p-1 m-1 filter-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col" style="z-index:1">
                                <div class="font-weight-medium ts-text">חיפוש לפי חודשים</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-vcenter card-table">
                    <tbody class="d-flex flex-column ts-text">
                        ...
                        ?>
                            ...
                            <tr>
                                <td class="ts-date text-center">
                                    <?php if ($commision["commission_status"] == COMMISSION_STATUS_PENDING) {
                                    ?><button class="btn btn-markaspaid" onclick='collectCommision(<?php echo json_encode($commision) ?>)'>סמן כשולם←</button><?php
                                                                                                                                                            } else {
                                                                                                                                                                echo '<button class="btn btn-paid">שולם</button>';
                                                                                                                                                            } ?>
                        ...
                        <tr>
                            ...
                            <td class="text-muted ts-store-name">חודש: 01/2024</td>
                            <td class="ts-guy-name">שם הישיבה: ת”ת תומכי תורה</td>
                        </tr> -->
...
<script>
    function collectCommision(data) {
        console.log(data)

        jQuery('#mark-as-paid-confirmation').modal('show');
        let modal = document.querySelector('#mark-as-paid-confirmation');

        modal.querySelector('#year').value = data.year;
        modal.querySelector('#month').value = data.month;
        modal.querySelector('#entity_id').value = data.entity_id;
    }
    // @formatter:off
