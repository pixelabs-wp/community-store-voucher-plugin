...
.community-management-popup, .store-management-popup{
    display: none;
}
                ...
                <div class="card card-sm p-relative" style="position: relative;">
                    <div class="filter-popup" id="filter-guys-popup" style="z-index: -1;">
                        <div class="" style="direction: rtl;">
                            ...
                            <select type="text" class="form-select" placeholder="Select tags" id="guys-select-tags"
                                value="" multiple>
                                <option value="HTML">HTML</option>
                                <option value="JavaScript">JavaScript</option>
                                <option value="CSS">CSS</option>
                ...
                <table class="table table-vcenter card-table">
                    <tbody class="d-flex flex-column ts-text">
                        <tr>
                            ...
                            <td class="ts-guy-name">שם החנות: אקסוס</td>
                        </tr>
