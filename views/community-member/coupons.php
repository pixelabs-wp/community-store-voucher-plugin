...
<style>
    ...
    #filter-categories-popup-svg,
    #filter-stores-popup-svg,
    #filter-products-popup-svg,
    ...
    .filter-popup {
        ...
        box-shadow: 0px 1px 14px 6px #00000012;
        z-index: -1;
        padding: 30px;
        margin-top: 56px;
    }
    ...
    <div
                ...
                <div class="card-body-rounded p-1 m-1">
                    <form action="" method="POST" class="m-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <div class="font-weight-medium ts-text"> <input name="product_name"
                                        style="direction: rtl;" class="border-0 w-100" placeholder="חיפוש מוצרים.."
                                        type="text"></div>
                    ...
                    <form action="" method="POST">
                        <div class="" style="direction: rtl;">
                            ...
                            <select name="stores_array[]" type="text" class="form-select" placeholder="Select tags"
                                ...
                                foreach ($pageData["vouchers"] as $data) {
        ...
        <div class="col-sm-5 col-lg-3 m-0">
            <div class="card card-sm p-relative" style="position: relative;">
                ...
                <div class="filter-popup" id="filter-products-popup" style="z-index: -1;">

                    <form action="" method="POST">
                        <div class="" style="direction: rtl;">
                            <label class="form-label">סינון חנויות</label>
                            <select name="product_array[]" type="text" class="form-select" placeholder="Select tags"
                                id="products-select-tags" value="" multiple>
                                <option value="">asdasd</option>
                                <?php
                            ...
                            <input type="hidden" name="filter_by_product">
                            <button type="submit" class="btn btn-primary bg-black mt-3">Filter</button>
                        </div>
                    </form>
                ...
                <div class="card-body-rounded p-1 m-1 filter-card">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <span id="filter-products-popup-svg"
                                class="bg-white text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/shopping-cart -->
                                <svg width="42" height="40" viewBox="0 0 42 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
...
<div class="container mt-4 d-flex flex-wrap" style="row-gap: 2rem; column-gap: 5rem;">
    ...
    foreach ($pageData["vouchers"] as $voucher) {
        ?>
        <div class="store-management-card card col-xl-4 rounded-3 p-0">
            ...
            <div class="card-body d-flex p-0">
                ...
                <div class="d-flex flex-column px-5 py-4" style="width: 65%;">
                        ...
                        <div class="row-1 p-2 d-flex align-items-center justify-content-end">
                            <table>
                                ...
                                <tr class="d-flex flex-column gap-2 text-center">
                                    ...
                                    <td>
                                        <?php echo $voucher["product_name"]; ?>
                                    </td>
                                    <td><strong>שם החנות: </strong>
                                        <?php echo $voucher["store_data"]->store_name; ?>
                                    </td>
                                    <td><strong>מחיר: </strong>
                                        <?php echo $voucher["voucher_price"]; ?>₪ במקום
                                        <?php echo $voucher["normal_price"]; ?>₪
                                    </td>
                    ...
                    <button
                        onclick='buyVoucher(JSON.stringify(<?php echo json_encode($voucher); ?>), "<?php echo $community_member->get_community_member_by_user_id(array("wp_user_id" => get_current_user_id()))->id; ?>")'
                        class="btn btn-dark p-3">← לרכישת השובר </a>
                </div>

                <div class="w-35"
                    style="border-top-right-radius: 8px; border-bottom-right-radius: 8px; width: 35%; background-image: url(<?php echo home_url() . '/wp-content/uploads' . $voucher["product_image"]; ?>); background-position: center; background-size: cover; background-repeat: no-repeat;">
                </div>
    ...
    <div class="d-flex justify-content-between w-100">
        <a href="" style="color: white;" class="btn bg-dark py-3 px-5 rounded-3"> ← עמוד הבא </a>
        <a href="" style="color: white;" class="btn bg-dark py-3 px-5 rounded-3"> ← עמוד הבא </a>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect && (new TomSelect(el = document.getElementById('categories-select-tags'), {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect && (new TomSelect(el = document.getElementById('products-select-tags'), {
            copyClassesToDropdown: false,
            dropdownParent: 'body',
            controlInput: '<input>',
            render: {
