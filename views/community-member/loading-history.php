...
<div class="container p-0">
  <div class="container col-12 mt-5">
    <div class="row row-cards justify-content-sm-between gap-sm-3 gap-2 gap-lg-0 bg-black px-2 py-3 m-0 rounded-3">
        ...
        <div class="card card-sm p-relative">
          <div class="card-body-rounded p-1 m-1 filter-card">
            <div class="row align-items-center">
              ...
              <div class="col">
                <div class="font-weight-medium ts-text"> ייצוא טעינות ל אקסל</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-5 col-lg-3 m-0">
        <div class="card card-sm p-relative" style="position: relative;">
          ...
          <div class="filter-popup" id="filter-load-popup" style="z-index: -1;">
            <div class="" style="direction: rtl;">
              <form action="" method="POST">
                <label class="form-label">סינון טעינות</label>
                <select type="text" class="form-select" placeholder="Select tags" name="id_array[]" id="load-select-tags" value=""
                  multiple>
                  <?php
                  foreach ($pageData["transactions"] as $key => $transaction) {
                ...
                <input type="hidden" name="filter_by_load_id">
          ...
          <div class="card-body-rounded p-1 m-1 filter-card">
            <div class="row align-items-center">
              <div class="col-auto">
                <span id="filter-load-popup-svg" style="cursor: pointer;"
              ...
              <div class="col">
                <div class="font-weight-medium ts-text">סינון טעינות</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <table class="table table-vcenter card-table">
          <tbody class="d-flex flex-column ts-text">
            <?php foreach ($pageData["transactions"] as $key => $transaction) {
              ...
              <tr>
                <td class="ts-date">
                  <?php echo date('d/m/Y', strtotime($transaction->created_at)); ?> :תאריך
                </td>

                <td class="text-muted ts-price">₪
                  <?php echo $transaction->balance_amount; ?>:סכום
                </td>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      var el;
      window.TomSelect && (new TomSelect(el = document.getElementById('load-select-tags'), {
