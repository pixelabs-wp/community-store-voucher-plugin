...
<div class="container">
	...
	<div class="modal fade" id="community-member-shop-details-popup" tabindex="-1" aria-labelledby="exampleModalLabel"
		aria-hidden="true">
								...
								<div class="card card-content ">
									...
									<div class="card-body">
										...
										<div class=" mx-auto h-32"
											style=" background-color: #01051D; width: 200px; height: 40px; border-radius: 10px; margin-top: 50px;">
							...
							<div class="card-bodyer">
								<div class="card card-content ">
									...
									<div class="card-body">
										...
										<div class=" mx-auto h-32"
											style=" text-align: center; background-color: #01051D; width: 200px; height: 40px; border-radius: 10px; margin-top: 50px;">
											<h5 class="phone">לרכישת השובר ←</h5>
										</div>
									</div>
								</div>
