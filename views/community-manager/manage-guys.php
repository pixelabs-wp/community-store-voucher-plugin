...
<div class="modal fade" id="community-member-guy-full-detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-xl modal-dialog-centered modal-dialog-scrollable ">
    <div class="modal-content " style="overflow: auto;">

      <div class="main-container">
        <div class="guys-full-details-header w-100 d-flex flex-row bg-dark justify-content-between align-items-center p-4" style="direction: rtl;">
          <h2 class="text-white m-0" style="font-family: Noto Sans Hebrew; font-size: 36px; font-weight: 900;">משה
            וענונו
          </h2>
          <button class="btn bg-white rounded " style="font-family: Noto Sans Hebrew; font-size: 24px; font-weight: 800;">חזרה לתפריט
            הראשי</button>
        </div>
        <div class="guys-full-details-body d-flex flex-row justify-content-center row" style="direction: rtl;">
          ...
          <div class="col-lg-7 p-4 bg-white rounded-3 my-5 mx-2" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25); direction: rtl;">
      ...
      <div class="col-sm-5 col-lg-3 m-0">
        <div class="card card-sm p-relative" style="position: relative;">
          ...
          <div class="card-body-rounded p-1 m-1 filter-card">
            <div class="row align-items-center">
              <div class="col-auto">
                <span id="date-range-popup-svg" class="bg-white text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/shopping-cart -->
        ...
        <table class="table table-vcenter card-table">
          ...
          <tbody class="d-flex flex-column ts-text">
            ...
            ?>
                <tr>
                  <td class="ts-date">
                    <div class="card card-sm bg-black ts-round" style="direction: rtl;" data-bs-toggle="modal" data-bs-target="#community-member-guy-full-detail" onclick="populateOrderDetailModalFunction(this)" data-member-details='<?php echo json_encode($member); ?>' data-member-details='<?php echo json_encode($member); ?>' data-voucher-details='<?php echo json_encode($member); ?>'>
