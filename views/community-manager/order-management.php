...
<div class="container">
	...
	<div class="d-flex flex-row gap-3 mt-3 flex-wrap" style="height: 700px; overflow-y: auto;">
		<?php foreach ($pageData['all_order_data'] as $order_data) {
			...
			$store_logo = esc_url(get_site_url() . '/wp-content/uploads/') . $order_data['store_data']->store_logo;

			?>
			<div class="card order-management-cards col-xl-4 rounded-3">
				<!-- Photo -->
				<div class="" style="">
					<img src="<?php echo $store_logo; ?>" style="object-fit: cover; width: 100%; height: 130px;" alt="">
				</div>
				<div class="card-body px-3">
					<div class="d-flex justify-content-between">
						<?php echo $status; ?>
						<span class="btn btn-dark">מס’ הזמנה: <?php echo $order_data['id']; ?></span>
					</div>
					...
					<p class="card-footer-text pt-4 pb-2">סה”כ הזמנה: <?php echo $order_data['order_total']; ?> ₪</p>
				</div>
			</div>
		<?php } ?>
