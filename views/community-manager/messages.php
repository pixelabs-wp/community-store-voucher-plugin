    ...
    <div class="card-x">
        ...
        <h2 class="accordion-header" id="heading-1">
          <div class="container-xl button-op-cl p-0 m-0">
            <button class="button-open p-2"
              style="background-color: #F9F8C7; color: black; font-size: 20px; font-weight: 600;" id="button-open"
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="heading-2">
          <div class="container-xl button-op-cl p-0 m-0">
            <button class="button-open p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2"
              aria-expanded="true">
              ← לחץ לפתיחה
            </button>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="heading-3">
          <div class="container-xl button-op-cl p-0 m-0">
            <button class="button-open p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3"
              aria-expanded="true">
              ← לחץ לפתיחה
            </button>
            <div class="content">תאריך: 25/10/2018</div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="heading-4">
          <div class="container-xl button-op-cl p-0 m-0">
            <button class="button-open p-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4"
              aria-expanded="true">
              ← לחץ לפתיחה
            </button>
            <div class="content">תאריך: 25/10/2018</div>
